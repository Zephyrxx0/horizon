...
- None to follow — this phase _establishes_ the patterns (state management, styling tokens, testing conventions) all later phases inherit.
...
_Phase: 1-Foundation, Design System & Persistence Engine_
