...
export function GovtBadge({ variant = 'emblem', className = '', size = 'md' }: GovtBadgeProps) {
  ...
  > = {
    ...
    'fast-track': {
      ...
      icon: Sparkles,
      badgeClass:
        'bg-amber-50 dark:bg-amber-950/40 text-amber-800 dark:text-amber-300 border border-amber-200/80 dark:border-amber-900/50',
    ...
    verified: {
      ...
      icon: CheckCircle2,
      badgeClass:
        'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-900/50',
