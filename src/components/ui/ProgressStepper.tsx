          ...
          return (
            ...
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-full shrink-0">
                ...
                {isCurrent && (
                  <div className="w-7 h-7 rounded-full bg-[var(--color-indigo-primary)] text-[var(--color-surface-bg)] flex items-center justify-center text-sm font-semibold">
                    {idx + 1}
                  </div>
                )}
                {isNeedsAttention && (
                  <AlertTriangle className="w-6 h-6 text-[var(--color-error)]" aria-hidden="true" />
                )}
