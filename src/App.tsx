...
function MainContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-surface-bg)] text-[var(--color-ink)] transition-colors duration-150">
      ...
      {/* Main Workspace & Side-by-Side Assistant Container */}
      <div className="flex-1 flex overflow-hidden w-full relative">
        {/* Left / Center: Main App Portal Content */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-xs">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <p className="text-[var(--color-footer-text-muted)] leading-relaxed max-w-md text-xs">
                    Official electronic visa portal managed by the Bureau of Immigration, Ministry
        ...
        {/* Right: AI Assistant Companion Panel (Same Layer, occupies right space) */}
        <AssistantSheet
      ...
      {/* Floating AI Assistant Trigger (Hidden when panel is open on desktop/mobile) */}
      {!isAssistantOpen && (
